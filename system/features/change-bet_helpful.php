...
$query = "SELECT a2_b1_id, a2_result_team_1, a2_result_team_2 FROM a2_bets WHERE a2_b1_id = '".$Mecz."'";
$result = mysql_query($query) or die(mysql_error());
while ($row = mysql_fetch_array($result)) {
	$a2_b1_id = $row['a2_b1_id'];
...
<tr>
	...
	<td class="center_align"><b>$a2_result_team_1 - $a2_result_team_2</b></td>
