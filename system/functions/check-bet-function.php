<?php
//include "sign-of-a-number-function.php";

function check_bet($result_1, $result_2, $match) {
	
	//okreœlenie znaku liczby (ró¿nica wyników danego meczu)
	...
	while ($row = mysql_fetch_array($result)) {
		...
		//okreœlenie znaku liczby (ró¿nica typów danego meczu)
		...
		if ($result_1 == $a2_result_team_1 && $result_2 == $a2_result_team_2) {
			...
			if ($match == 64) {
			//dodanie +10 punktów za wytypowanie prawid³owego faworyta
		...
		} else if (sign($result) == sign($a2_result_team)) { //niestety trza to usun¹æ: (gmp_sign($result_1-$result_2) == gmp_sign($a2_result_team_1-$a2_result_team_2)
